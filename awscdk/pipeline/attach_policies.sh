...
aws iam attach-role-policy --policy-arn arn:aws:iam::102460195799:policy/baseIamUserGrants --role-name ${pipeline_role}
aws iam attach-role-policy --policy-arn arn:aws:iam::102460195799:policy/miscAllows --role-name ${pipeline_role}
aws iam attach-role-policy --policy-arn arn:aws:iam::102460195799:policy/limitedIAM --role-name ${pipeline_role}
aws iam attach-role-policy --policy-arn arn:aws:iam::aws:policy/PowerUserAccess --role-name ${pipeline_role}
